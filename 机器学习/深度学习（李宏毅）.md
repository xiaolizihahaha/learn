...
- 拿这个函数到训练集之外的地方的测试（验证），去更改model
  ...
  **linear model就是f（x） = b + wx**，其中f（x）与x是线性相关的，这使得linear model 太过简单了，使得linear model有很多局限（这些局限称为model bias）
  ...
  ![image-20231214181546250](/Users/lifangyuan/Library/Application Support/typora-user-images/image-20231214181546250.png)
...
- 全连接前馈网络fully connect feedforward network
  ...
  ![image-20231214205506454](/Users/lifangyuan/Library/Application Support/typora-user-images/image-20231214205506454.png)
...
- **recvNet**（残差结构块网络）
  ...
  ![image-20231219214531222](/Users/lifangyuan/Library/Application Support/typora-user-images/image-20231219214531222.png)
...
- LSTM（性能比RNN好得多，但是时间复杂度比较高）
  ...
  ![image-20231220185237075](/Users/lifangyuan/Library/Application Support/typora-user-images/image-20231220185237075.png)
...
- 步骤：
  ...
  4. 网络图：
     ...
     ![image-20231220205638802](/Users/lifangyuan/Library/Application Support/typora-user-images/image-20231220205638802.png)

     

     ![image-20231220205705550](/Users/lifangyuan/Library/Application Support/typora-user-images/image-20231220205705550.png)
...
- 深度学习做古诗：
  ...
  - 再，输入rnn，要求： 比如说何日平胡虏，我们输入何到rnn和fc中，要求输出日；输入日到rnn和fc中，要求输出平；输入平到rnn和fc中，要求输出胡；输入胡到rnn和fc中，要求输出虏；如图所示。那么假设词典中一共有4000个记录，那么一个字对应的输出就有4000个，4000个里面每一个输出代表作为下一个输出的概率。
    ...
    ![image-20231221111555332](/Users/lifangyuan/Library/Application Support/typora-user-images/image-20231221111555332.png)
